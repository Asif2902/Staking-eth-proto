...
import { updateAccountCenter, updateNotify, customNotification, setLocale, setPrimaryWallet, setWalletModules, updateTheme, updateAppMetadata } from './store/actions.js';
declare const API: {
    ...
    state: {
        ...
        actions: {
            ...
            updateAppMetadata: typeof updateAppMetadata;
        };
    };
};
export type OnboardAPI = typeof API;
export type { InitOptions, ConnectOptions, DisconnectOptions, WalletState, ConnectedChain, AccountCenter, AppState, CustomNotification, Notification, Notify, UpdateNotification, PreflightNotificationsOptions, Theme, WagmiConfig } from './types.js';
