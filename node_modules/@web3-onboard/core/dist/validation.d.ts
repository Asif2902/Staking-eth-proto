import { type ChainId, type DecimalChainId, type WalletInit, type WalletModule, type ValidateReturn, type AppMetadata } from '@web3-onboard/common';
...
export declare function validateAppMetadataUpdate(data: AppMetadata | Partial<AppMetadata>): ValidateReturn;
